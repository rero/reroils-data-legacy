...
from reroils_data.organisations.fetchers import \
    organisation_id_fetcher as fetcher
from reroils_data.organisations.minters import organisation_id_minter as minter


def test_organisation_id_fetcher(app, db):
