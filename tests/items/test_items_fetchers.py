...
from reroils_data.items.fetchers import item_id_fetcher as fetcher
from reroils_data.items.minters import item_id_minter as minter


def test_item_id_fetcher(app, db):
