...
from reroils_data.locations.fetchers import location_id_fetcher as fetcher
from reroils_data.locations.minters import location_id_minter as minter


def test_location_id_fetcher(app, db):
