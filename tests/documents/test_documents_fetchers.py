...
from reroils_data.documents.fetchers import document_id_fetcher as fetcher
from reroils_data.documents.minters import document_id_minter as minter


def test_document_id_fetcher(app, db):
