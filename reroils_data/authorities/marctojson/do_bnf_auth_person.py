...
class Transformation(object):
    ...
    def _build_string_list_from_fields(self, tag, subfields, separator):
        ...
        """
        fields = self.marc.get_fields(tag)
        filed_string_list = []
        for field in fields:
            subfield_list = []
    ...
    def trans_bnf_biographical_information(self):
        ...
        for tag in tag_list:
            biographical_information += \
                self._build_string_list_from_fields(str(tag), 'a', ', ')
    ...
    def trans_bnf_preferred_name_for_person(self):
        ...
        preferred_name_for_person = \
            self._build_string_list_from_fields('200', 'ab', ', ')
    ...
    def trans_bnf_variant_name_for_person(self):
        ...
        variant_name_for_person = \
            self._build_string_list_from_fields('400', 'ab', ', ')
    ...
    def trans_bnf_authorized_access_point_representing_a_person(self):
        ...
        authorized_access_point_representing_a_person = \
            self._build_string_list_from_fields('200', 'abcdf', ', ')
